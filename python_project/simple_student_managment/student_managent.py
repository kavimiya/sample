...
student_table = ttk.Treeview(main_frame, columns=(
  "ID", "Name", "Gender", "Age", "DOB", "10Mark", "12Mark", "GPA"
...
student_table.heading("10Mark", text="10Mark")
student_table.heading("12Mark", text="12Mark")
...
student_table.column("10Mark", width=100)
student_table.column("12Mark", width=100)
...
data=[
  ...
  ["12112322", "John", "25", "Male", "2020.09.01", "40", "70", "3.1"],
  ["12177774", "Sara", "21", "Female", "2021.08.01", "98", "80", "4.5"],
  ["12177774", "Steven", "27", "Male", "2016.04.01", "88", "85", "3.5"],
]
...
for record in data:
  if count % 2 == 0:
    student_table.insert(parent="", index="end", iid=count, text="", values=(record[0], record[1],record[2],record[3],record[4],record[5],record[6],record[7]), tags=("evenrow"))
  else:
    student_table.insert(parent="", index="end", iid=count, text="", values=(record[0], record[1],record[2],record[3],record[4],record[5],record[6],record[7]), tags=("oddrow"))
